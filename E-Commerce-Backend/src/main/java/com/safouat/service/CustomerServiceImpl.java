...
import com.safouat.repository.SessionDao;
...
//		System.out.println(c.getProducts().size());
	...
	public Customer getCurrentlyLoggedInSeller(String token) throws SellerException {
		...
		Customer existingSeller=customerDao.findById(user.getUserId()).orElseThrow(()->new SellerException("Customer not found for this ID"));
